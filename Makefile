...
# Trigger building the experimental benchmark tools
ifdef BUILD_BENCHMARKS
	CMAKE_BUILD_BENCHMARKS = -DBUILD_BENCHMARKS=true
endif
...
client: check_client client_thirdparty set_version
	$(CMAKE_BIN) -Hcpp -B$(XTREEMFS_CLIENT_BUILD_DIR) --check-build-system CMakeFiles/Makefile.cmake 0 $(CLIENT_DEBUG) $(CMAKE_BOOST_ROOT) $(CMAKE_BUILD_CLIENT_TESTS) $(CMAKE_SKIP_FUSE) ${CMAKE_BUILD_PRELOAD} $(CMAKE_BUILD_BENCHMARKS)
